...
Here we can see that evne if we wanted to remove the no info form our data set there is a substantial amount of points that may contribute to our models variance.
